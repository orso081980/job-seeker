...
const COLORS: Record<Status, string> = {
  ...
  maybe: "bg-sky-100 text-sky-700 dark:bg-sky-900 dark:text-sky-200",
  contacted: "bg-amber-100 text-amber-700 dark:bg-amber-900 dark:text-amber-200",
  connected: "bg-purple-100 text-purple-700 dark:bg-purple-900 dark:text-purple-200",
  proposition: "bg-brand-100 text-brand-700 dark:bg-brand-900 dark:text-brand-200",
  contracted: "bg-brand-200 text-brand-800 dark:bg-brand-700 dark:text-brand-100",
